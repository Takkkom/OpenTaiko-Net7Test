...
namespace TJAPlayer3
{
    ...
    class NotesManager
    {
            ...
            Color4 normalColor, Color4 effectedColor, int x末端, int y末端)
        {
            ...
            _texarr.t2D中心基準描画((int)_center_x, (int)_center_y, new Rectangle(rollOrigin + TJAPlayer3.Skin.Game_Notes_Size[0] + _offset, 0, TJAPlayer3.Skin.Game_Notes_Size[0], TJAPlayer3.Skin.Game_Notes_Size[1]));
